...
public class Calculator {
    ...
    public void help_text(){
        String[] calc_help_text = new String[] {
        ...
        output_manager.print_string_array(calc_help_text);
    }
    ...
    /**
     * Try to run all calculations on the given array, starting with * and / TODO add div
    ...
    public double calculation(String[] calc_array){
        ...
        if (helper.array_contains(calc_array, "*")) {
            ...
            System.out.println("Wanted Cal operation contains not valid operation");
            return 0;
        }
    ...
    public void start(){
        ...
        System.out.println("Type 'help' for Information about this Calculator");
        while (!exit_calc){
